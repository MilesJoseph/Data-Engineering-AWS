...
select_counts_queries= [get_count_staging_events, get_count_staging_songs, get_count_songplays, get_count_users, get_count_songs, get_count_artists, get_count_time]
